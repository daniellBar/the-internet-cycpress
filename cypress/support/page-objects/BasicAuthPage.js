...
export const requestPage = (creds = null) => {
    ...
    if (username && password) {
        cy.log(`requesting page with credentials. username: ${username}, password: ${password}`)
...
export const navigateToPageWithCreds = (creds) => {
    const { username, password } = { ...creds }
    cy.log(`navigating to page with credentials. username: ${username}, password: ${password}`)
